...
namespace Tervania.Items.Souls.Normal.Underground {
    ...
    public class JellyfishSoulDrop : GlobalNPC {
        public override void NPCLoot(NPC npc) {
            if (npc.TypeName == "Blue Jellyfish") TervaniaUtils.DropItem(npc, 5f, mod.ItemType<Items.Souls.Normal.Underground.JellyfishSoul>());
            if (npc.TypeName == "Pink Jellyfish") TervaniaUtils.DropItem(npc, 5f, mod.ItemType<Items.Souls.Normal.Underground.JellyfishSoul>());
        }
    }
}